                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="block w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:border-indigo-600 focus:ring-4 focus:ring-indigo-50 transition-all outline-none"
                            />
                        </div>
